import { Box, Card, Typography, Grid, Button, ButtonProps } from "@mui/material"
...
const ListView: ListViewWithChildren = ({ children }) => <div className="flex flex-col w-[100%] rounded">  <AppBar /> <Box p={2}>
